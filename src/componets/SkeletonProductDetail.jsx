  ...
  return (
    <div className="md:flex md:gap-10 px-8 py-3 md:px-24 md:py-6 lg:px-32 lg:py-10">
      <div className="flex pb-8 md:pb-0 md:flex-col gap-3 w-full md:gap-8 w-2/6 ">
        <div className="h-[200px] w-full bg-[#DBDBDBE6] font-bold italic text-white flex items-center justify-center">
          loading..
        </div>
        <div className="h-[200px] w-full bg-[#DBDBDBE6] text-white font-bold italic flex items-center justify-center">
          loading..
        </div>
      </div>
