            ...
            <li className="pb-1  relative">
              <Link to="/checkout" title="Shopping Cart">
                <img
                  ...
                  alt=""
                />
                <div className="absolute -top-1 -right-2 bg-red-300 text-white p-[2px] px-[4px] rounded-[100%] text-[10px]">
            ...
            >
              ...
              {hoveredIndex ? (
                ...
                >
                  ...
                  <Link className="p-2 border" to="/signin">
                    Signin
                  </Link>
                  <Link className="p-2 border" to="/register">
                    Register
                  </Link>
                </div>
              ) : (
