  ...
  return (
    <div id="mens" className="flex flex-col gap-10 w-full px-6 ">
      ...
      <div className="flex  gap-8 relative ">
        <div className="border -left-6 z-10 top-32 absolute p-3 border-black">
                    <svg
            ...
            <div className='overflow-x-scroll flex  gap-8'>
                ...
                <div key={product.id} className="flex flex-col gap-4 ">
                    <div className='h-80 w-140'>
                        <img className='object-cover h-full w-full' src={product.image} alt={product.name} />
                    </div>
